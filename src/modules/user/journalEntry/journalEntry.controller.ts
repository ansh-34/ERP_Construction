...
import { UserJournalEntryService } from './journalEntry.service.js';
...
export const createJournalEntry = async (req: Request, res: Response) => {
  try {
    const data = await UserJournalEntryService.create(
      req.user!.domainId,
      req.user!.adminId,
      req.body,
    );
...
export const listJournalEntries = async (req: Request, res: Response) => {
  try {
    const { data, pagination } = await UserJournalEntryService.list(
      req.user!.domainId,
      req.user!.adminId,
      req.query,
    );
...
export const getJournalEntry = async (req: Request, res: Response) => {
  try {
    const data = await UserJournalEntryService.getById(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
    );
...
export const updateJournalEntry = async (req: Request, res: Response) => {
  try {
    const data = await UserJournalEntryService.update(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
      req.body,
...
export const deleteJournalEntry = async (req: Request, res: Response) => {
  try {
    await UserJournalEntryService.delete(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
    );
...
export const postJournalEntry = async (req: Request, res: Response) => {
  try {
    const data = await UserJournalEntryService.post(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
    );
...
export const reverseJournalEntry = async (req: Request, res: Response) => {
  try {
    const data = await UserJournalEntryService.reverse(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
    );
