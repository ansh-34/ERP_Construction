...
import { purchasePriceAlertService } from '../../../services/alerts/purchasePriceAlert.service.js';
...
export const InvoiceService = {
  ...
  async listActiveInvoices(authDomainId: string, query: Record<string, any>) {
    return InvoiceService.listInvoices(authDomainId, {
      ...query,
      lifecycle: 'ACTIVE',
    });
  },
  ...
  async generateFromPurchaseOrder(
    ...
    await purchasePriceAlertService.createPriceIncreaseAlerts({
      domainId,
      adminId,
      candidates: result.priceIncreaseAlerts,
    });
