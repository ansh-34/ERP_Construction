...
import { JournalEntryLineService } from './journalEntryLine.service.js';
...
export const createJournalEntryLine = async (req: Request, res: Response) => {
  try {
    const data = await JournalEntryLineService.create(
      req.user!.domainId,
      req.user!.adminId,
      req.body,
    );
...
export const listJournalEntryLines = async (req: Request, res: Response) => {
  try {
    const { data, pagination } = await JournalEntryLineService.list(
      req.user!.domainId,
      req.user!.adminId,
      req.query,
    );
...
export const getJournalEntryLine = async (req: Request, res: Response) => {
  try {
    const data = await JournalEntryLineService.getById(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
    );
...
export const updateJournalEntryLine = async (req: Request, res: Response) => {
  try {
    const data = await JournalEntryLineService.update(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
      req.body,
...
export const deleteJournalEntryLine = async (req: Request, res: Response) => {
  try {
    await JournalEntryLineService.delete(
      req.user!.domainId,
      req.user!.adminId,
      req.params.id,
    );
