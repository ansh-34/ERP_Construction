...
import { DomainIndustryAccountCategoryService } from './industryAccountCategory.service.js';
...
export const listIndustryAccountCategories = async (
  ...
  try {
    const { data, pagination } =
      await DomainIndustryAccountCategoryService.list(req.query, language(req));
