export const Messages = Object.freeze({
  ...
  CUSTOMER_RATE: {
    CREATED: 'Customer rate created successfully',
    RETRIEVED: 'Customer rate retrieved successfully',
    LIST_RETRIEVED: 'Customer rates retrieved successfully',
    UPDATED: 'Customer rate updated successfully',
    DELETED: 'Customer rate deleted successfully',
    NOT_FOUND: 'Customer rate not found',
    CREATE_FAILED: 'Failed to create customer rate',
    LIST_FAILED: 'Failed to retrieve customer rates',
    UPDATE_FAILED: 'Failed to update customer rate',
    DELETE_FAILED: 'Failed to delete customer rate',
  },
  CUSTOMER: {
    CREATED: 'Customer created successfully',
    RETRIEVED: 'Customer retrieved successfully',
    LIST_RETRIEVED: 'Customers retrieved successfully',
    UPDATED: 'Customer updated successfully',
    DELETED: 'Customer deleted successfully',
    NOT_FOUND: 'Customer not found',
    CREATE_FAILED: 'Failed to create customer',
    LIST_FAILED: 'Failed to retrieve customers',
  ...
  SALE_ORDER: {
    CREATED: 'Sale order created successfully',
    RETRIEVED: 'Sale order retrieved successfully',
    LIST_RETRIEVED: 'Sale orders retrieved successfully',
    UPDATED: 'Sale order updated successfully',
    DELETED: 'Sale order deleted successfully',
    NOT_FOUND: 'Sale order not found',
    CREATE_FAILED: 'Failed to create sale order',
    LIST_FAILED: 'Failed to retrieve sale orders',
    UPDATE_FAILED: 'Failed to update sale order',
    DELETE_FAILED: 'Failed to delete sale order',
  ...
  ACCOUNT_CATEGORY: {
    CREATED: 'Account category created successfully',
    RETRIEVED: 'Account category retrieved successfully',
    LIST_RETRIEVED: 'Account categories retrieved successfully',
    UPDATED: 'Account category updated successfully',
    DELETED: 'Account category deleted successfully',
    NOT_FOUND: 'Account category not found',
    PARENT_NOT_FOUND: 'Parent account category not found',
    DUPLICATE_CODE: 'An account category with this code already exists',
    HAS_CHILDREN: 'Account category with child categories cannot be deleted',
    HAS_ACCOUNTS: 'Account category with linked accounts cannot be deleted',
    PARENT_HAS_ACCOUNTS:
      'Cannot add a sub-category to a category that already has accounts',
    CATEGORY_TYPE_MISMATCH:
      'Sub-category type must match its parent category type',
    CREATE_FAILED: 'Failed to create account category',
    LIST_FAILED: 'Failed to retrieve account categories',
    UPDATE_FAILED: 'Failed to update account category',
    DELETE_FAILED: 'Failed to delete account category',
  },
  ACCOUNT: {
    CREATED: 'Account created successfully',
    RETRIEVED: 'Account retrieved successfully',
    LIST_RETRIEVED: 'Accounts retrieved successfully',
    ...
    CATEGORY_NOT_LEAF:
      'Selected account category is not a leaf and cannot be used for an account',
    DUPLICATE_CODE: 'An account with this code already exists',
    HAS_CHILDREN: 'Account with child accounts cannot be deleted',
    HAS_LEDGER_ENTRIES: 'Account with ledger history cannot be deleted',
  ...
  COST_CENTER: {
    ...
    RETRIEVED: 'Cost center retrieved successfully',
    LIST_RETRIEVED: 'Cost centers retrieved successfully',
    UPDATED: 'Cost center updated successfully',
    DELETED: 'Cost center deleted successfully',
    NOT_FOUND: 'Cost center not found',
    PARENT_NOT_FOUND: 'Parent cost center not found',
    DUPLICATE_CODE: 'A cost center with this code already exists',
    HAS_CHILDREN: 'Cost center with child cost centers cannot be deleted',
    HAS_ACCOUNTS: 'Cost center linked to accounts cannot be deleted',
    INVALID_INDUSTRY_ACCOUNT: 'One or more industry account ids are invalid',
    INVALID_INDUSTRY_CATEGORY:
      'One or more industry account category ids are invalid',
    CREATE_FAILED: 'Failed to create cost center',
    LIST_FAILED: 'Failed to retrieve cost centers',
    UPDATE_FAILED: 'Failed to update cost center',
    DELETE_FAILED: 'Failed to delete cost center',
  },
  GENERAL_LEDGER: {
    RETRIEVED: 'General ledger entry retrieved successfully',
    LIST_RETRIEVED: 'General ledger entries retrieved successfully',
    NOT_FOUND: 'General ledger entry not found',
    LIST_FAILED: 'Failed to retrieve general ledger entries',
  },
  ACCOUNT_BALANCE: {
    RETRIEVED: 'Account balance retrieved successfully',
    LIST_RETRIEVED: 'Account balances retrieved successfully',
    NOT_FOUND: 'Account balance not found',
    LIST_FAILED: 'Failed to retrieve account balances',
  },
  WEIGH_BRIDGE: {
