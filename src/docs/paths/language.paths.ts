...
export const LanguagePaths = {
                  ...
                  data: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        name: { type: 'object', example: { en: 'English' } },
          ...
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  success: { type: 'boolean', example: true },
                  message: { type: 'string', example: 'Language created' },
                  data: {
                    type: 'object',
                    properties: {
                      id: { type: 'string', format: 'uuid' },
  ...
  '/api/user/language/{id}': {
    get: {
      tags: ['User Language'],
      summary: 'Get user language by ID',
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          in: 'path',
          ...
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  success: { type: 'boolean', example: true },
                  message: { type: 'string', example: 'Language retrieved' },
                  data: {
                    type: 'object',
                    properties: {
                      id: { type: 'string', format: 'uuid' },
