...
async function enrichPoProductsWithCodes(products: any[], domainId: string) {
  ...
  return products.map((pop: any) => {
    ...
    return {
      ...
      uomSymbol: pop.uom?.symbol || match?.uom?.symbol || null,
      lastPurchasePrice: pop.lastPurchasePrice ?? null,
      lastPurchaseCurrencyId: pop.lastPurchaseCurrencyId ?? null,
      lastPurchaseVendorId: pop.lastPurchaseVendorId ?? null,
      lastPurchaseVendorName: pop.lastPurchaseVendorName ?? null,
        ...
        include: {
          purchaseOrderProducts: {
            select: {
              ...
              lastPurchaseCurrencyId: true,
              lastPurchaseVendorId: true,
              lastPurchaseVendorName: true,
              projectId: true,
              domainId: true,
              status: true,
              isDeleted: true,
