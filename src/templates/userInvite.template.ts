/**
 * Email template: User Invite
 * Sent when a domain owner invites a new user to join their domain.
 */
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="background-color:#151823;border-radius:16px;border:1px solid #1e2235;overflow:hidden;max-width:520px;width:100%;">
          <!-- Header -->
          <tr>
            <td style="background:linear-gradient(135deg,#2563eb 0%,#3b82f6 50%,#60a5fa 100%);padding:36px 40px;text-align:center;">
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 12px;color:#94a3b8;font-size:14px;line-height:1.7;">
                You've been invited to join <strong style="color:#e2e8f0;">${domainName}</strong> on the Construction ERP platform.
              </p>
              <p style="margin:0 0 28px;color:#94a3b8;font-size:14px;line-height:1.7;">
                Click the button below to verify your account and get started. This invitation expires in <strong style="color:#e2e8f0;">24 hours</strong>.
              </p>
              <!-- CTA Button -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="${verificationLink}" style="display:inline-block;background:linear-gradient(135deg,#2563eb,#3b82f6);color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 36px;border-radius:10px;letter-spacing:0.3px;">
                      Accept Invitation
                    </a>
                  </td>
                </tr>
